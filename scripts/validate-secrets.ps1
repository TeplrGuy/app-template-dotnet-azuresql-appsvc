...
Write-Host ""
Write-Host "🔐 GitHub Secrets & Variables Validator" -ForegroundColor Magenta
...
$requiredSecrets = @(
    ...
    @{ Name = "AZURE_SQL_AAD_ADMIN_NAME"; Description = "Azure AD SQL Admin Display Name" },
    @{ Name = "AZURE_SQL_AAD_ADMIN_OBJECT_ID"; Description = "Azure AD SQL Admin Object ID" }
)
...
if ($missingSecrets.Count -gt 0 -or $missingVariables.Count -gt 0) {
    Write-Host "🔧 Commands to set missing items:" -ForegroundColor Yellow
    Write-Host ""
